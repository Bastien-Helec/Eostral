...
$Suppression_Call_JS = new JS_CALL_FORM('Suppression_Compte_div', 'Suppression', 'banner');
echo $Suppression_Call_JS->gen_print_FORM_js();

$Suppression_remove_js = new JS_Remove_Event('Suppression_Compte_div', 'Suppression');
echo $Suppression_remove_js->gen_remove_js();

$send_suppression = new Send('Suppression_Compte_form', 'Model/Model_Back.php');
$send_suppression->Send();
